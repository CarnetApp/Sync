    ...
    private void refreshWrapperList(){
        try {
            for(Class wrapperClass : WrapperFactory.wrappers){
                ...
                m = wrapperClass.getMethod("getFriendlyName");
                m.setAccessible(true);
                String friendlyName = (String) m.invoke(wrapperClass);
                m = wrapperClass.getMethod("getAccountType");
                m.setAccessible(true);
                int accountType = (Integer) m.invoke(wrapperClass);
                createAccountTypeView(friendlyName, null, accountType);
            }
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton(R.string.create, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        WrapperFactory.getWrapper(AccountTypeActivity.this, accountType, account.accountID).startAuthorizeActivityForResult(AccountTypeActivity.this);
                    }
